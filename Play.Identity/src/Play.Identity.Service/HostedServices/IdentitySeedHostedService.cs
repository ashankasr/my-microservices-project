...
namespace Play.Identity.Service.HostedServices
{
    public class IdentitySeedHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            await CreateRoleIfNotsExistsAsync(Roles.Admin, roleManager);
            await CreateRoleIfNotsExistsAsync(Roles.Player, roleManager);
        ...
        private static async Task CreateRoleIfNotsExistsAsync(
            string role,
